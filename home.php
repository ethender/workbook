...
<html lang="en">
  ...
  <body>
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="" class="active">Name</a></li>	
							</ul>
						</div>
					</div>						
				</div>
	...
	<div class="feature" style="margin-top: 100px;margin-bottom: 50px;">
		<div class="container">
			<div class="row">
				<div class="col-md-12 hi-icon-wrap hi-icon-effect wow fadeInDown" >
				<center>
				<a href="create.html" class="btn btn-info" role="button">Create New</a>
				</center>
				</div>
			</div>
			<div class="row">
